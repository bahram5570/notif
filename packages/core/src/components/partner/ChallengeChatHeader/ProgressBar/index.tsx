...
export const ProgressBar = ({ progress, avatar, partnerAvatar, className }: ProgressBarPropsType) => {
  const milestones = [
    { percent: progress.goldPercent, text: progress.goldText, img: '/assets/shared/images/gold.webp', isGold: true },
    {
      percent: progress.silverPercent,
      text: progress.silverText,
      img: '/assets/shared/images/silver.webp',
      isGold: false,
    },
    {
      percent: progress.bronzePercent,
      text: progress.bronzeText,
      img: '/assets/shared/images/bronze.webp',
      isGold: false,
    },
  ];
