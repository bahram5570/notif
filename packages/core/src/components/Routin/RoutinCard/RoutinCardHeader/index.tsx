import PartyingFaceIcon from '@assets/shared/icons/Partying Face.svg';
import SmilingFaceIcon from '@assets/shared/icons/Smiling Face.svg';
import ThinkingFaceIcon from '@assets/shared/icons/Thinking Face.svg';

import { RoutinBookmarked } from '../../RoutinBookmarked';
import RoutinProgressBar from './RoutinProgressBar';
import { RoutinCardHeaderPropsType } from './types';
...
const RoutinCardHeader = ({
  ...
  const backgroundHandler = () => {
    if (percentage === 100) {
      ...
      return 'bg-impo_Yellow_100 dark:bg-impo_Yellow_700';
    } else {
      return 'bg-impo_Pink_100 dark:bg-impo_Pink_700';
    }
  };
