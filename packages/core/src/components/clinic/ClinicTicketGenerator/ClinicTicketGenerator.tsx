    ...
    <div className="w-full cursor-pointer" onClick={navigateTicketHandler}>
      <div
        className={`
                    ...
                    rounded-xl 
                    pointer-events-none 
                    ${props.stylingTypes === 'heading' ? (isMan ? 'bg-impo_PrimaryMan_PrimaryMan' : 'bg-impo_Primary_Primary') : 'bg-impo_Neutral_Surface'}
                  `}
      >
        ...
        <div
          className={`
                      ...
                      h-[1px] 
                      my-2
                      ${props.stylingTypes === 'heading' ? (isMan ? 'bg-impo_Blue_400' : ' bg-impo_Pink_400') : 'bg-impo_Neutral_Surface dark:bg-impo_Surface_SurfaceVariant'}
