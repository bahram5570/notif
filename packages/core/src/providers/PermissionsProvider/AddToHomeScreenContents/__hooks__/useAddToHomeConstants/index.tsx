...
import ShareIcon from '@assets/shared/icons/share.svg';
      ...
      items: [
        {
          ...
          image: '/assets/shared/images/addToHomeScreen/safariOld_1.webp',
        },
        {
          no: 2,
          script: ['به پایین رفته و گزینه Add to homescreen را لمس کنید'],
          image: '/assets/shared/images/addToHomeScreen/safariOld_2.webp',
        },
      ...
      items: [
        {
          ...
          image: '/assets/shared/images/addToHomeScreen/safariNew_1.webp',
        },
        {
          no: 2,
          script: ['از منوی باز شده، روی گزینه share کلیک کنید'],
          image: '/assets/shared/images/addToHomeScreen/safariNew_2.webp',
        },
        {
          no: 3,
          script: ['به پایین رفته و گزینه Add to homescreen را لمس کنید'],
          image: '/assets/shared/images/addToHomeScreen/safariNew_3.webp',
        },
        {
          no: 4,
      ...
      items: [
        {
          ...
          image: '/assets/shared/images/addToHomeScreen/chromeIos_1.webp',
        },
        {
          no: 2,
          script: ['به پایین رفته و گزینه Add to homescreen را لمس کنید'],
          image: '/assets/shared/images/addToHomeScreen/chromeIos_2.webp',
        },
        {
          no: 3,
          script: ['حالا دیگه ایمپو کنار بقیه اپلیکیشن های شماست!'],
      ...
      items: [
        {
          ...
          image: '/assets/shared/images/addToHomeScreen/chromeAndroid_1.webp',
        },
        {
          no: 2,
          script: ['به پایین رفته و گزینه Add to homescreen را لمس کنید'],
          image: '/assets/shared/images/addToHomeScreen/chromeAndroid_2.webp',
        },
        {
          no: 3,
          script: ['حالا دیگه ایمپو کنار بقیه اپلیکیشن های شماست!'],
