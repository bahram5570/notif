...
const preset: Config = {
  ...
  theme: {
    colors: {
      ...
      impo_Cycle_Pms_Text: 'var(--color-Cycle_Pms_Text)',
      impo_Cycle_Pms_Wave: 'var(--color-Cycle_Pms_Wave)',
      impo_Cycle_Pms_Background: 'var(--color-Cycle_Pms_Background)',
      impo_Cycle_Pms_Frame: 'var(--color-Cycle_Pms_Frame)',
      impo_Cycle_Ovulation_Text: 'var(--color-Cycle_Ovulation_Text)',
      impo_Cycle_Ovulation_Wave: 'var(--color-Cycle_Ovulation_Wave)',
      impo_Cycle_Ovulation_Background: 'var(--color-Cycle_Ovulation_Background)',
      impo_Cycle_Ovulation_Frame: 'var(--color-Cycle_Ovulation_Frame)',
      impo_Cycle_Normal_Text: 'var(--color-Cycle_Normal_Text)',
      impo_Cycle_Normal_Wave: 'var(--color-Cycle_Normal_Wave)',
      impo_Cycle_Normal_Background: 'var(--color-Cycle_Normal_Background)',
      impo_Cycle_Normal_Frame: 'var(--color-Cycle_Normal_Frame)',
      impo_Cycle_Period_Text: 'var(--color-Cycle_Period_Text)',
      impo_Cycle_Period_Wave: 'var(--color-Cycle_Period_Wave)',
      impo_Cycle_Period_Background: 'var(--color-Cycle_Period_Background)',
      impo_Cycle_Period_Frame: 'var(--color-Cycle_Period_Frame)',
      impo_Cycle_Pregnancy_Text: 'var(--color-Cycle_Pregnancy_Text)',
      impo_Cycle_Pregnancy_Wave: 'var(--color-Cycle_Pregnancy_Wave)',
      impo_Cycle_Pregnancy_Background: 'var(--color-Cycle_Pregnancy_Background)',
      impo_Cycle_Pregnancy_Frame: 'var(--color-Cycle_Pregnancy_Frame)',
      impo_Cycle_Feeding_Text: 'var(--color-Cycle_Feeding_Text)',
      impo_Cycle_Feeding_Wave: 'var(--color-Cycle_Feeding_Wave)',
