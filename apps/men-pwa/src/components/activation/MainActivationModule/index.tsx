...
const MainActivationModule = (props: MainActivationModuleProps) => {
  ...
  return (
    ...
    >
      ...
      <Suspense>
        <ContinueBtn
          currentRewardData={props.rewardId ? props.rewardData?.[props.rewardId]?.data : undefined}
      ...
      {hasOnMountReward && (
        <OnMountRewardModule
          currentRewardData={props.onMountRewardId ? props.rewardData?.[props.onMountRewardId]?.data : undefined}
          orderOfRewardElements={props.orderOfRewardElements}
          noBackButton={props.noBackButton}
          firstName={props.firstName}
        />
