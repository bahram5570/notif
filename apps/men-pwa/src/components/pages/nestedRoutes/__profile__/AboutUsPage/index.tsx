        ...
        <div className="flex flex-col items-center justify-center gap-8">
          <div className="flex flex-col items-center justify-center">
            <div className="flex flex-col items-center justify-center gap-6">
              <CustomTypography className="text-impo_PrimaryMan_PrimaryMan" fontSize="Headline_Large">
                Impo
              </CustomTypography>
              ...
              <div className="flex flex-col items-center justify-center">
                ...
                <CustomTypography className="text-impo_PrimaryMan_PrimaryMan" fontSize="Headline_Medium">
                  I am important
                </CustomTypography>
                <CustomTypography className="text-impo_Surface_OnSurfaceVariant" fontSize="Lable_Large">
                  یعنی من مهم هستم
