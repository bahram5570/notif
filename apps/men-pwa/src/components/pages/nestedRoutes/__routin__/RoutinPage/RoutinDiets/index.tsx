...
const RoutinDiets = ({ name, items }: RoutinDietsProps) => {
  return (
    <>
      <CustomTypography fontSize="Lable_Large" className="text-impo_Neutral_OnBackground pb-4 pt-1 ml-auto">
        {name}
      </CustomTypography>
      ...
      {items.map((item, index) => {
        ...
        return (
          <div key={index}>
            {index > 0 && <div className="w-full h-[1px] my-4 bg-impo_Surface_SurfaceVariant" />}
