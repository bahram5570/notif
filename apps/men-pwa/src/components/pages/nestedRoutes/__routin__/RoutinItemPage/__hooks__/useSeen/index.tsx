import { IS_LAST_ROUTIN_ITEM, SHOW_ROUTIN_UNLOCK_TOST } from '@repo/core/components/Routin/RoutinUnlockTost';
...
const useSeen = () => {
  ...
  const successHandler = () => {
    if (checkIsLastItem) {
      ...
      refetchQuery({ queryKey: ['manhealthprogramItem'] });
    } else {
  ...
  const { callApi, isLoading } = usePwaApi({
    api: 'widgets/manhealthprogram/item/compelet',
    method: 'POST',
