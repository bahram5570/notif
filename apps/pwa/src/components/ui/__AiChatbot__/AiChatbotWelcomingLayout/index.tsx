...
const AiChatbotWelcomingLayout = ({ children, updateTopHandler }: WelcomingLayoutPropsType) => {
  ...
  useEffect(() => {
    const updateTop = () => {
      ...
      updateTopHandler(rect.height * 0.7);
    };
...
export default AiChatbotWelcomingLayout;
