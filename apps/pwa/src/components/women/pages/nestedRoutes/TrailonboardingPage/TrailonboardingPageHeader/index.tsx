...
import { TrailonboardingPageHeaderPropsType } from './type';

const TrailonboardingPageHeader = ({ progress, IsLastItem, totalPages }: TrailonboardingPageHeaderPropsType) => {
...
export default TrailonboardingPageHeader;
