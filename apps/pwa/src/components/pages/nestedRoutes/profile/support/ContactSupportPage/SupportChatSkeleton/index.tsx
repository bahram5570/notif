        ...
        <div className="flex flex-col items-center justify-center w-full gap-8">
          <div className="flex flex-col items-center justify-center w-full">
            <div className="flex flex-col items-center justify-center gap-6 animate-skeleton w-full p-6">
              <div className="w-full h-[200px] rounded-xl bg-impo_Neutral_Surface" />
              <div className="w-[200px] h-[40px] absolute bottom-3 mx-auto mb-5 rounded-full bg-impo_Neutral_Surface" />
            </div>
          </div>
        </div>
      </div>
...
export default SupportChatSkeleton;
