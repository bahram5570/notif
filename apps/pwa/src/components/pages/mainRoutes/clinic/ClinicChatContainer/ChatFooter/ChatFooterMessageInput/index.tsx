    ...
    <div className="w-full flex items-center gap-2">
      <div className="w-full h-10 px-4 flex items-center justify-between gap-2 border-[1px] rounded-full border-impo_Neutral_Surface">
        ...
        <input
          ...
          className="border-none outline-none w-full bg-impo_Neutral_Background text-impo_Neutral_OnBackground placeholder:text-impo_Surface_SurfaceVariant"
      ...
      >
        {textLoading && <Dark_Spinner size={20} className="border-impo_White" />}
