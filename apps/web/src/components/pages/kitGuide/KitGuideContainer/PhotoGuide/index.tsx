  ...
  return (
    <div style={{ background: COLORS_LIST.Surface_SurfaceVariant }} className="min-w-full px-4 py-5">
      <div className="rounded-xl mb-3 px-4 py-5" style={{ background: COLORS_LIST.White }}>
        ...
        <div className="my-[18px] pr-[10px]">
          ...
          <CustomTypography fontSize="Body_Medium">
            ۲. عکس رو در بازه زمانی مؤثر نوار تست بگیرید (معمولاً ۵-۱۰ دقیقه یا ۱۰-۳۰ دقیقه؛ برای جزئیات به
            دستورالعمل‌های نوار تست مراجعه کنید).
          </CustomTypography>
        </div>
      </div>
      ...
      <div className="rounded-xl mb-3 px-4 py-5" style={{ background: COLORS_LIST.White }}>
        ...
        <div>
          <CustomImage
            src="/assets/images/kitGuide/sampleKit.webp"
            alt="sampleKit"
            width={1122}
            height={312}
            priority={true}
        ...
        <div className="flex flex-row gap-2">
          <div>
            <CustomImage src="/assets/images/kitGuide/falseImg1.webp" alt="falseImg1" width={504} height={355} />
            <div className="flex items-center gap-1 my-2">
              <CloseIcon />
          ...
          <div>
            <CustomImage src="/assets/images/kitGuide/falseImg2.webp" alt="falseImg2" width={504} height={355} />
            <div className="flex items-center gap-1 my-2">
              <CloseIcon />
      ...
      <div className="rounded-xl mb-5 px-4 py-5" style={{ background: COLORS_LIST.White }}>
        ...
        <div className="my-[18px] pr-[10px]">
          <div className="flex gap-1 flex-col items-start">
            ...
            <CustomTypography fontSize="Body_Medium">
              ۲. کادر راهنمای کیت تخمک‌گذاری رو با خط C نوار تست تراز کنید.
            </CustomTypography>
