  ...
  return (
    <HeaderFooterContainer>
      <div className="w-full pt-[100px] md:pt-[150px] md:w-11/12 lg:w-10/12 px-4 md:px-0">
        ...
        <CustomTypography tagType="p" fontSize="Body_Large" className="!text-impo_Neutral_OnBackground mb-6 w-full">
          {props.description}
        </CustomTypography>
        {props.linkedin && (
          <div className="flex items-center gap-x-1 mb-6">
            <LinkdinIcon className="w-6 stroke-impo_Primary_Primary" />
            <CustomLink href={props.linkedin} className="!text-impo_Primary_Primary">
              <CustomTypography tagType="p" fontSize="Body_Large">
                {`پروفایل لینکدین`}
              </CustomTypography>
            </CustomLink>
          </div>
        ...
        <div>
          <CustomTypography tagType="h3" fontSize="Headline_Small" className="!text-impo_Neutral_OnBackground mb-6">
          ...
          <CustomTypography tagType="p" fontSize="Body_Medium" className="!text-impo_Neutral_OnBackground mb-6">
            ...
            <CustomLink href={'/content-integrity'} className="!text-impo_Primary_Primary mx-[3px]">
