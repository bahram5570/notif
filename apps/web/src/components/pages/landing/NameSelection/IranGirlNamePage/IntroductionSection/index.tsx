  ...
  return (
    <div className="flex justify-start flex-col">
      ...
      <CustomTypography fontSize="Body_Large" color={'Surface_InverseSurface'}>
        ...
        تک‌تک
        <CustomLink color="Primary_Primary" href="/pregnancy-symptoms">
          علائم بارداری
        </CustomLink>
        به دنبال
        <CustomLink color="Primary_Primary" href="/pregnancy-symptoms-of-having-a-boy">
      ...
      <CustomTypography fontSize="Body_Large" color={'Surface_InverseSurface'}>
        ...
        بارداری، از
        <CustomLink color="Primary_Primary" href="/calendarOfPregnancy">
          محاسبه سن بارداری،
        </CustomLink>
        ...
        <CustomLink color="Primary_Primary" href="/landing/boy-name">
          اسم پسر
        </CustomLink>
        رو هم امتحان کنی.
      </CustomTypography>
