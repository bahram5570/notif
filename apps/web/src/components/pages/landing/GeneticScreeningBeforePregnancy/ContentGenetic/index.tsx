...
const ContentGenetic = async () => {
  ...
  return (
    <div className="w-full flex flex-col gap-5 pt-10 pb-10 px-4 sm:px-0 lg:w-10/12 lg:mx-auto">
      <CustomTypography tagType="h1" fontSize="Title_Medium" className=" !text-impo_Neutral_OnBackground">
        راهنما کامل آزمایش ژنتیک قبل از بارداری و تست آنلاین رایگان
      </CustomTypography>
      <CustomTypography className="text-justify !text-impo_Neutral_OnBackground" tagType="p">
      ...
      <div>
        <CustomTypography tagType="h2" fontSize="Title_Small" className="!text-impo_Neutral_OnBackground">
      ...
      <div>
        ...
        <ul className="mr-4 mt-4">
          <CustomTypography className="list-disc !text-impo_Neutral_OnBackground" tagType="li">
            <CustomTypography tagType="h3" className="!text-impo_Neutral_OnBackground">
              بیماری‌های تک ژنی
            </CustomTypography>
          </CustomTypography>
          <CustomTypography className="pt-4 pb-2 !text-impo_Neutral_OnBackground" tagType="p">
      ...
      <div>
        <CustomTypography tagType="h2" fontSize="Title_Medium" className="mb-4 !text-impo_Neutral_OnBackground">
          سوالات متداول
        </CustomTypography>
