  ...
  result1: {
    ...
    section2: [
      ...
      },
      {
        ...
        text: 'در موارد با ریسک بالا، می‌تونی چکاپ‌های خون عمومی مورد نیازت رو با هومکا انجام بدی! این آزمایش‌ها توسط مشاور ژنتیک، برات تجویز می‌شه. آزمایشگاه آنلاین هومکا، انواع آزمایش‌های تشخیصی رو در منزل و محل کار (در مناطق تحت پوشش)، تحت پوشش بیمه پایه و تکمیلی، برات انجام میده. ',
    ...
    section2: [
      {
        ...
        icon: '/assets/images/geneticMarketing/lowRisk/1.webp',
        text: 'در طول دوره بارداری و اقدام به بارداری  باید حسابی حواست به خودت باشه.  کلی نکات مراقبتی هست که باید توی این مسیر رعایت کنی. ایمپو این نکات رو بهت یاد میده توی این مسیر اجازه نمیده  آب تو دلت تکون بخوره.',
        btnName: 'نصب ایمپو',
        btnUrl: '/download',
      },
      {
