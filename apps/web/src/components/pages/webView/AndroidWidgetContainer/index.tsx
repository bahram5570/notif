import AndroidIcon from '@assets/images/webView/widgetAndroid/android.svg';
...
const AndroidWidgetContainer = () => {
  return (
    <div className="bg-[#F7F7F7] p-4">
      ...
      <div className="mt-4">
        <AndroidIcon className="flex justify-self-end ml-[38px]" />
...
export default AndroidWidgetContainer;
