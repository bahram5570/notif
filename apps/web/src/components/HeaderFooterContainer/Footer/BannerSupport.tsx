...
const BannerSupport = () => {
  return (
    <CustomLink
      ...
      className="flex items-center justify-center w-full h-20 py-4 px-3 bg-impo_Pink_500 !text-impo_White z-10 text-center fixed left-0 right-0 bottom-0 hover:opacity-[1]"
    >
