export const BREASTFEEDING_HEADING_DATA = {
  title: 'رشد و مراقبت از مادر و کودک با ایمپو!',
  description:
    'با ایمپو، رشد و سلامت خودت و کوچولوت رو دنبال کن و با اطلاعات دقیق و راهنمایی‌های کاربردی، این مسیر مهم رو با آرامش و اطمینان طی کن.',
  gradientFrom: '#F3F5FE',
  gradientTo: '#C9D6FB',
  image: '/assets/images/headingBreastfeeding.webp',
};

export const BREASTFEEDING_ACHIEVEMENTS_LIST = [
  { title: '20000000 +', subTitle: 'چرخه ثبت شده' },
  { title: '3000000 +', subTitle: 'نصب ایمپو' },
  { title: '1000 +', subTitle: 'مقاله منتشر شده' },
];

export const BREASTFEEDING_COMMENTS_LIST = [
  {
