import TestOnlineContainer from '@components/pages/landing/GeneticScreeningBeforePregnancy/TestOnlineContainer';
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${HOST_URL}/genetic-screening-before-pregnancy/testonline`,
  },
};
